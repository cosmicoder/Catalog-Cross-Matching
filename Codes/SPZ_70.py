# Cross-matching SPITZER SWIRE 70 micron catalog with GMRT catalog

import numpy as np
import math

# New file to store data
ofile = open('SPITZER_70_match4.txt', mode='w')

# Loading csv data into program references
spitzer = np.loadtxt('CSV_Files/SPITZER_70_reduced.csv', delimiter=',')
