# Cross-matching SPITZER SERVS 3.6 micron catalog with GMRT catalog

import numpy as np
import math
# New file to store data
ofile = open('SPITZER_servs1_match4.txt', mode='w')

# Loading csv data into program references
spitzer = np.loadtxt('CSV_Files/SPITZER_servs1_reduced.csv', delimiter=',')
...
one = 0
two = 0
three = 0   # Variables to note statistic distribution of data
four = 0
five = 0
six = 0
