# Cross-matching SPITZER SERVS 2-Band catalog with GMRT catalog

import numpy as np
import math

# New file to store data
ofile = open('SPITZER_servs12_match4.txt', mode='w')

# Loading csv data into program references
spitzer = np.loadtxt('CSV_Files/SPITZER_servs12_reduced.csv', delimiter=',')
