# Cross-matching SPITZER SWIRE 160 micron catalog with GMRT catalog

import numpy as np
import math

# New file to store data
ofile = open('CSV_Files/SPITZER_160_match4.txt', mode='w')

# Loading csv data into program references
spitzer = np.loadtxt('CSV_Files/SPITZER_160_reduced.csv', delimiter=',')
